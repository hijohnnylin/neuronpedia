...
Run this after changing anything under ``neuronpedia_inference/schemas/`` or a route
signature -- ``make openapi`` from this directory. It needs no model loaded and no GPU:
``app.openapi()`` only reads route signatures.
