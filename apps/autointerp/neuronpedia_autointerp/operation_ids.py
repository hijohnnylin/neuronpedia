...
exist for exactly one audience: whoever calls `neuronpedia-autointerp-client`.
...
An identical copy of this lives in ``apps/inference``. The two servers are separate projects with
