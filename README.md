...
4.  use Swagger UI to make calls in your browser:
    ...
    > ⚠️ **warning:** once you go to [localhost:8080](http://localhost:8080), you will need to click `Servers` and select `http://localhost:5002/v1`, and click `Authorize` and enter the value from `INFERENCE_SERVER_SECRET` in `.env.localhost`.
