...
> ⚠️ **warning:** once you go to [localhost:8080](http://localhost:8080), you will need to click `Servers` and select `http://localhost:5003/v1`, and click `Authorize` and enter the value from `AUTOINTERP_SERVER_SECRET` in `.env.localhost`.
